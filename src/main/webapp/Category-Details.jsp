...
<body id="page-top" class="">
	...
	<div id="wrapper">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div
						...
						<h1 class="h3 mb-0 text-gray-800">View Books Categorey</h1>
						<!-- 	<a href="#"
							...
							<div class="card-body">
								<div class="table-responsive">
									<table id="categoryTable"
										class="table table-bordered icon-container" id="dataTable"
		...
		<jsp:include page="/Category-Update.jsp"></jsp:include>
