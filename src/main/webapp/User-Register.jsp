...
<div class="wrapper"
			...
			<form id="registration_form"
				...
				<div class="form-wrapper">
					<input type="text" name="user_name" id="user_name"
						placeholder="Name" class="form-control" autofocus required>
				...
				<div class="form-group">
					<input type="text" name="user_mobile" id="user_mobile"
						...
						name="Birth_Date" id="Birth_Date" placeholder="Birth Date"
				...
				<div class="form-wrapper">
					<input type="text" name="user_address" id="user_address"
						placeholder="Address" class="form-control" required> <i
						class="zmdi zmdi-pin"></i>
				</div>
				<div class="form-wrapper">
					<input type="password" name="password" id="password"
						placeholder="Password" class="form-control" required> <i
				...
				<button type="submit" name="register" id="register" value="submit">
	...
	<script src="<%=request.getContextPath() %>/resources/js/registrationform_validation.js"></script>
</body>
</html>