				...
				<a class="dropdown-item d-flex align-items-center" href="#">
					<div class="dropdown-list-image mr-3">
						<img class="rounded-circle"
							src="resources/images/static-img/undraw_profile_1.svg" alt="...">
					...
					<div class="dropdown-list-image mr-3">
						<img class="rounded-circle"
							src="resources/project-images/undraw_profile_2.svg" alt="...">
					...
					<div class="dropdown-list-image mr-3">
						<img class="rounded-circle"
							src="resources/project-images/undraw_profile_3.svg" alt="...">
	...
	<ul class="navbar-nav ml-auto">
		...
		<li class="nav-item dropdown no-arrow"><a
			...
			aria-expanded="false"> <span
				class="mr-2 d-none d-lg-inline text-gray-600 small"><%= adminEmail %></span>
				<img class="img-profile rounded-circle"
				src="resources/images/static-img/undraw_profile.svg">
		</a> <!-- Dropdown - User Information -->
			<div
				class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
				aria-labelledby="userDropdown">
				<a class="dropdown-item" href="#" onclick="getAdminDetails()"> <i
