		...
		success: function(response) {
			if (response.success) {
				...
				var finalTotalRow = '<div class="cart-item">' +
					'<div class="row">' +
					'<div class="col-md-8 text-right"><strong>Total Amount:</strong></div>' +
				...
				var checkoutBtn = '<div class="row  checkout-btn " style="display: none; margin-top:20px;">' +
					...
					'<div class="col-md-2 text-right"><a href="#" class="btn btn-success btn-sm" onclick="AmountFetching(' + true + ')">CHECKOUT</a></div>' +
					'</div>';

				// Append the checkout button and apply token button
				var applyTokenbtn = '<div class="row apply-token-row" style="margin-top:20px;">' +
					'<div class="col-md-10 text-right"><a href="#" class="btn btn-primary btn-sm apply-token-btn" onclick="toggleSummaryRow()"><i class="fa fa-percent"></i> Apply Token</a></div>' +
					'<div class="col-md-2 text-right"><a href="#" class="btn btn-success btn-sm checkwitouttkn" onclick="AmountFetching(' + false + ')">CHECKOUT</a></div>' +
					'</div>';
