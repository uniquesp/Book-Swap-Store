...
<button id="openModalButton" onclick="openModalButton()">Open Update User Modal</button>

<div id="updateUserModal" class="modal">
    <!-- Modal content and form here -->
</div>
...
<script>
  ...
  // Add your other JavaScript functions here, like updateUserProfile() if it's not already defined.
</script>
